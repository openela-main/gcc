...
echo 'OpenELA %{version}-%{gcc_release}' > gcc/DEV-PHASE.native
echo 'OpenELA %{version}-%{gcc_release} cross from %{_arch}' > gcc/DEV-PHASE.cross
...
CC="$CC" CXX="$CXX" CFLAGS="$OPT_FLAGS" \
	...
	--with-bugurl=https://bugs.openela.org/ \
